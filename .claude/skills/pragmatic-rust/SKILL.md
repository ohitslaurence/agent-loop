---
name: pragmatic-rust
description: Guidelines for writing pragmatic, performant and readable Rust code
license: MIT
metadata:
  author: (c) Microsoft Corporation
  version: "1.0.0"
---
...
Any public library module must have inner doc comments (//!) and the first sentence must follow [M-FIRST-DOC-SENTENCE].
