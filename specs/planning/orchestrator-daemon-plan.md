...
- [R] Implement artifact mirroring to `global_log_dir` with references stored in SQLite (See Section 3.2, Section 7.1)
...
- [x] Add storage tests for migrations and event persistence (See Section 3.2, Section 6.2)
