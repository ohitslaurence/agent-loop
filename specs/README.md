...
| [consecutive-failure-detection.md](./consecutive-failure-detection.md) | [consecutive-failure-detection-plan.md](./planning/consecutive-failure-detection-plan.md) | `crates/loopd`, `crates/loop-core` | Abort runs after repeated phase failures |
| [open-skills-orchestration.md](./open-skills-orchestration.md) | [open-skills-orchestration-plan.md](./planning/open-skills-orchestration-plan.md) | `crates/loopd`, `crates/loop-core` | Skill discovery, selection, and prompt loading for OpenSkills/Agent Skills |
